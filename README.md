...
```bash
git clone https://github.com/mohit40kumar/Js-Language-Translator/edit/main/README.md
```
...
This language translator web application is developed and maintained   by (https://github.com/mohit40kumar). I am a passionate web developer with a keen interest in building useful and innovative projects using various web technologies.
